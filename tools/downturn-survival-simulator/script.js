document.addEventListener("DOMContentLoaded", function () {
  ...
  ["annualRevenue","annualFixedCosts","availableCash","annualDebtService"].forEach(attachNumFormat);
  ...
  function runDiagnostic() {
    ...
    const annualDebtService = parseNum(document.getElementById("annualDebtService").value) || 0;
    ...
    const report =
      ...
      "<tr><td>Baseline</td><td>" + formatNumber(annualRevenue) + "</td><td>" + formatNumber(grossProfit) + "</td><td>" + formatNumber(operatingProfit) + "</td><td>" + formatNumber((operatingProfit - annualDebtService) / 12) + "</td><td>n/a</td><td>current</td></tr>" +
